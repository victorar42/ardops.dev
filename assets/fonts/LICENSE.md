# Fonts License — ardops.dev

Las fuentes en este directorio se sirven self-hosted bajo la
...
- License: SIL Open Font License v1.1 (see below).

## Outfit

- Files: `outfit-400.woff2`, `outfit-600.woff2`, `outfit-700.woff2`
- Source: <https://github.com/Outfitio/Outfit-Fonts>
- Copyright 2020 The Outfit Project Authors
  (<https://github.com/Outfitio/Outfit-Fonts>).
- License: SIL Open Font License v1.1 (see below).

---

## SIL Open Font License v1.1 (texto completo)
